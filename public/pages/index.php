...
<body>
    <div id="nav-bar">
        ...
        <div id="menu" class="menu-style">
            ...
            <button id="view-menu">
                ...
                <div id="bar2" class="stylebar"></div>
                <div id="bar3" class="stylebar"></div>
            </button>
            <ul id="menu-list" class="style-menu-list">
                <li>
                ...
                <li id="view-services">
                    <a href="#">Serviços <img src="./assets/icons/arrow-dwon" alt="icone de seta parar baixo" id="icon-size"></a>
                </li>
                <li id="login-desktop">
                    <a href="http://localhost:7070/client">Entrar</a>
                </li>
    ...
    <div class="add-services-a">
        <ul>
            <li id="back">
                <img src="./assets/icons/arrow-up" alt="icone de seta para cima">
            </li>
            <li>
                <img src="./assets/icons/distributor" alt="icone de grupo de vendas">
                <a href="#">Revenda</a>
            </li>
            <li>
                <img src="./assets/icons/ticket" alt="icone de ticket">
                <a href="#">Tickets abertos</a>
            </li>
            <li>
                <img src="./assets/icons/support" alt="icone de suporte">
                <a href="#">Suporte</a>
            </li>
            <li>
                <img src="./assets/icons/complaint" alt="icone de reclamação">
                <a href="">Reclamação</a>
            </li>
        </ul>
   </div>
   <main class="container">
    <a href="#" id="contato"><img src="./assets/icons/whatisapp" alt="icone de whatisapp"></a>
        <!--Sobre apresentaç~ao-->
        ...
        <section id="ssh-description">
            ...
            <img id="illustration" src="./assets/illustrations/data-protection" alt="Ilustração de um Servidor protegido">
            <div class="types-description-ssh">
                <img src="./assets/icons/wireless" alt="icone de servidores">
                <div class="types-ssh">
                    <h4>Proxy Socks</h4>
         ...
         <section id="advantages-service">
            ...
            <div class="items-grup">
                ...
                <div class="items-column">
                    <div class="items-view">
                        <img src="./assets/icons/security" alt="">
                    ...
                    <div class="items-view">
                        <img src="./assets/icons/innovation" alt="">
                        <h4>Chamadas voip</h4>
         ...
         <section id="other-services">
            ...
            <div class="card-container">
                <div class="card-services">
                    <h5><img src="./assets/icons/bot" alt="imagem  de um robo"><span id="service-text">Crição de bots</span></h5>
                ...
                <div class="card-services">
                    <h5><img src="./assets/icons/ideias" alt="imagem  de um robo"><span id="service-text">Transforme sua Ideia em Realidade Digital!</span></h5>
